...
public class ChasingEnemy extends InteractiveEnemy {

    int frameCounter = 0;
    Point current = new Point(this.x / 1, this.y / 1);;

    static ArrayList<ChasingEnemy> chasingEnemies = new ArrayList<>();
    ...
    public ChasingEnemy(int x, int y, InteractivePanel gamePanel, String enemyType) {

        super(x, y, gamePanel, enemyType, null);
